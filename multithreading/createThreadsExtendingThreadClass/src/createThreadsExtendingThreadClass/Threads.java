package createThreadsExtendingThreadClass;

import ThreadRunnable.ThreadRunnable;
...
public class Threads {
	...
	public static void main(String[] args) {
		 ...
		 *  The threads can be created using two mechanism. This one will be by Extending the Thread Class.*/
